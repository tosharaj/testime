...
const icons: Record<string, React.ReactNode> = {
  ossc: (
    <span className="h-14 w-14 shrink-0 rounded-xl overflow-hidden bg-white border border-surface-200 flex items-center justify-center">
      <img src="/images/odisha_govt.png" alt="OSSC" className="h-full w-full object-contain p-0.5" />
    </span>
  ),
  osssc: (
    <span className="h-14 w-14 shrink-0 rounded-xl overflow-hidden bg-white border border-surface-200 flex items-center justify-center">
      <img src="/images/odisha_govt.png" alt="OSSSC" className="h-full w-full object-contain p-0.5" />
    </span>
  ),
  opsc: (
    <span className="h-14 w-14 shrink-0 rounded-xl overflow-hidden bg-white border border-surface-200 flex items-center justify-center">
  ...
  ssb: (
    <span className="h-14 w-14 shrink-0 rounded-xl overflow-hidden bg-white border border-surface-200 flex items-center justify-center">
      <img src="/images/odisha_govt.png" alt="SSB" className="h-full w-full object-contain p-0.5" />
    </span>
  ),
  'odisha-police': (
    <span className="h-14 w-14 shrink-0 rounded-xl overflow-hidden bg-white border border-surface-200 flex items-center justify-center">
  ...
  'odisha-teaching': (
    <span className="h-14 w-14 shrink-0 rounded-xl overflow-hidden bg-white border border-surface-200 flex items-center justify-center">
      <img src="/images/odisha_govt.png" alt="Odisha Teaching" className="h-full w-full object-contain p-0.5" />
    </span>
  ),
  'odisha-universities': (
    <span className="h-14 w-14 shrink-0 rounded-xl overflow-hidden bg-white border border-surface-200 flex items-center justify-center">
      <img src="/images/odisha_govt.png" alt="Odisha Universities" className="h-full w-full object-contain p-0.5" />
    </span>
  ),
  other: (
